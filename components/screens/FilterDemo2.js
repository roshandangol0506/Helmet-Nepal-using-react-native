import {
  ...
  const FlatlistDemo2 = ({navigation}) => {
      ...
      <View style={{flex: 1}}>
        <View
          ...
          <View
            ...
            <Image
              source={require('../database/images/assets/search.png')}
            ...
            {search == '' ? null : (
              <TouchableOpacity
                ...
                <Image
                  source={require('../database/images/assets/close.png')}
          ...
          <TouchableOpacity
            ...
            <Image
              source={require('../database/images/assets/filter.png')}
              ...
              <View
                ...
                <View style={{width: '80%'}}>
                  ...
                  <View
                    ...
                    <Image
                      source={require('../database/images/assets/star.png')}
